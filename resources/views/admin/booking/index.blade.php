    ...
    <div class="container">
        ...
        <div class="card">
          ...
          <div class="card-body" style="background-color: #aec9ef">
                        ...
                        <td>
                          @if ($booking->status == 2 || $booking->status == 4)
                            <div class="text-center">
                              <a href="{{ route('admin.booking.show',$booking->id) }}" class="btn btn-info mr-2 pl-3 pt-2 pb-2" data-toggle="tooltip" data-placement="bottom" title="{{ $booking->name }} Booking Detail"><i class="mdi mdi-eye"></i></a>  
                              <a href="{{ route('admin.booking.edit',$booking->id) }}" class="btn btn-warning mr-2 pl-3 pt-2 pb-2" data-toggle="tooltip" data-placement="bottom" title="{{ $booking->name }} Booking Edit"><i class="mdi mdi-pencil"></i></a>  
            ...
            @else
              <center class="text-black">No Any Booking Data</center>
            @endif
          </div>
        </div>
    </div>
