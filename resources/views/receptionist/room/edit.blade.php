...
<div class="content-wrapper">
    <div class="container">
        ...
        <form class="forms-sample" method="POST" action="{{ route('receptionist.room.update',$room->id) }}">
          @csrf
          @method('PUT')
            ...
            <input type="number" value="{{ $room->id }}" hidden required name="room_id">
            <input type="text" name="slug" hidden required value="Edit Req.">
            <br>
