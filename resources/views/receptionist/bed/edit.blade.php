...
<div class="content-wrapper">
    <div class="container">
        <h2 class="mt-1 mb-2">Request Edit Bed</h2>
        <hr class="mb-3 garis">
        <a class="text-white" href="{{ url()->previous() }}" style="text-decoration: none">< Back</a><br><br>

        <form class="forms-sample" method="POST" action="{{ route('receptionist.bed.update',$bed->id) }}">
          @csrf
          @method('PUT')
            ...
            <input type="number" value="{{ $bed->id }}" hidden required name="bed_id">
