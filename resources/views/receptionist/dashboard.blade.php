                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="card bg-primary">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <a href="{{ route('receptionist.bed.index') }}"><p class="card-text text-white">Detail <i class="fas fa-angle-double-right ml-2"></i> </p></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-2">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="card bg-primary">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <a href="{{ route('receptionist.class.index') }}"><p class="card-text text-white">Detail <i class="fas fa-angle-double-right ml-2"></i> </p></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-2">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="card bg-primary">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <a href="{{ route('receptionist.room.index') }}"><p class="card-text text-white">Detail <i class="fas fa-angle-double-right ml-2"></i> </p></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-2">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="card bg-primary">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <a href="{{ route('receptionist.room-number.index') }}"><p class="card-text text-white">Detail <i class="fas fa-angle-double-right ml-2"></i> </p></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-2">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="card bg-primary">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <a href="{{ route('receptionist.booking.index') }}"><p class="card-text text-white">Detail <i class="fas fa-angle-double-right ml-2"></i> </p></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-2">
