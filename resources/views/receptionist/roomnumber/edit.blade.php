...
<div class="content-wrapper">
    <div class="container">
        ...
        <form class="forms-sample" method="POST" action="{{ route('receptionist.room-number.update',$roomnumber->id) }}">
          @csrf
          @method('PUT')
            ...
            <br>
            <input type="text" class="form-control" id="room_number_id" name="room_number_id" hidden value="{{ $roomnumber->id }}">
            <input type="text" class="form-control" id="status" name="status" hidden value="Edit Req.">
