...
<div class="content-wrapper">
    <div class="container">
        ...
        <div class="row">
          <form class="forms-sample col-lg-6 border-right mb-4" method="POST" action="{{ route('customer.profile.update') }}">
            @csrf
            @method('PUT')
          ...
          <form action="{{ route('customer.password.update') }}" class="forms-sample col-lg-6" method="POST">
            @csrf
            @method('PUT')
