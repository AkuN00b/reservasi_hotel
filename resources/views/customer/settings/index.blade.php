...
<div class="content-wrapper">
    <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <form class="forms-sample border-right mb-4 pr-4" method="POST" action="{{ route('customer.profile.update') }}">
              @csrf
              @method('PUT')
          ...
          <div class="col-lg-6">
            <form action="{{ route('customer.password.update') }}" class="forms-sample mb-4" method="POST">
              @csrf
              @method('PUT')
            ...
            <form action="{{ route('customer.image.update') }}" class="forms-sample" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
