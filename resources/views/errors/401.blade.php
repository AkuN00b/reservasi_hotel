...
<html lang="en">
  <head>
    ...
    <title>Not Authorized 401 - {{ config('app.name') }}</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-7 mx-auto text-white">
              <div class="row align-items-center d-flex flex-row">
                ...
                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                  <h2>SORRY!</h2>
                  <h3 class="font-weight-light">Your Account is Disabled, contact {{ config('app.name') }} Administrator.</h3>
                </div>
              </div>
              <div class="row mt-5">
                <div class="col-12 text-center mt-xl-2">
                  <a class="nav-link count-indicator dropwdown-toggle text-white font-weight-medium" href="{{ route('logout') }}"
              ...
              <div class="row mt-5">
                <div class="col-12 mt-xl-2">
                  <p class="text-white font-weight-medium text-center">Copyright &copy; 2020 - <script>document.write(new Date().getFullYear());</script>. {{ config('app.name') }}. All rights reserved.</p>
                </div>
              </div>
            </div>
          </div>
